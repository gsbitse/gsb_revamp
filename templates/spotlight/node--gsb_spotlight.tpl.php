...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php print render($content['field_gsb_spotlight_title']); ?>

  <div class="content"<?php print $content_attributes; ?>>
    <?php
      // Make the file information an object.
      $file = (object) $field_gsb_spotlight_media[0];
      ...
      elseif ($file->type == 'video') {
        ...
        // Build the file theme array using the preview build mode.
        $build = file_view($file, 'preview');

        // If it's a youtube video we need to use the embed url.
        if ($build['#file']->filemime == 'video/youtube') {
    ...
    <?php print render($content['field_gsb_spotlight_quote']); ?>
    <?php print render($content['field_gsb_spotlight_description']); ?>
  </div>
